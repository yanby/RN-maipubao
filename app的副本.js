...
export default class App extends Component {
  ...
  render() {
    return <Router  backAndroidHandler={()=>{Actions.pop({});return true}} createReducer={reducerCreate} sceneStyle={{backgroundColor:'#F7F7F7'}}>

              <Scene key="root" >

                <Scene key='AppUserStatus' component={AppUserStatus} hideNavBar={true} />

                <Scene key="Login" onBackAndroid={()=>{return false}} backAndroidHandler={()=>{return false}} component={Login} title="登录"  hideNavBar={true} navigationBarStyle={styles.navigationBar} leftButtonIconStyle={styles.leftButtonIcon} titleStyle={styles.title}></Scene>
                <Scene key="Register" component={Register} title="注册"   hideNavBar={false} backButtonImage={require('./images/back.png')} navigationBarStyle={styles.navigationBar} leftButtonIconStyle={styles.leftButtonIcon} leftButtonTextStyle={styles.leftButtonText} titleStyle={styles.title}></Scene>
                <Scene key="ShortcutLogin" component={ShortcutLogin}  title="登录" leftTitle="取消" rightTitle="注册" navigationBarStyle={styles.navigationBar} leftButtonIconStyle={styles.leftButtonIcon} leftButtonTextStyle={styles.leftButtonText} titleStyle={styles.title} rightButtonIconStyle={styles.rightButtonIcon} rightButtonTextStyle={styles.rightButtonText} onLeft={()=>Actions.Login({})} onRight={()=>Actions.Register({})}></Scene>
                ...
                <Scene key='ScanCode' title ="ScanCode" hideTabBar={true} hideNavBar={true}  component={ScanCode} onBack={()=>{Actions.Index()}}/>
                ...
                <Scene key="CreatNewAccount" onBack={()=>{Actions.Index({})}} component={CreatNewAccount} title="创建账号" backButtonImage={require('./images/back.png')} navigationBarStyle={styles.navigationBar} leftButtonIconStyle={styles.leftButtonIcon} titleStyle={styles.title}/>
                ...
                <Scene key='upPortal' showLabel={true} tabBarPosition={'bottom'} showIcon={true}  hideTabBar={true} lazy={true} tabs={true} hideNavBar={true}  tabBarStyle={{backgroundColor:"#fff"}}>
                       <Scene key='indexKey'   icon={TabBarIcon} barIndex={0}>
                            ...
                            <Scene key="DemandInput" hideTabBar={true} hideNavBar={false} component={DemandInput} title="需求录入" onBackAndroid={()=>{Actions.popTo('Index',{})}}  backButtonImage={require('./images/back.png')} navigationBarStyle={styles.navigationBar} leftButtonIconStyle={styles.leftButtonIcon} titleStyle={styles.title}/>
                       ...
                       <Scene key='project'  title='项目'  hideNavBar={true} icon={TabBarIcon} barIndex={1} >
                               <Scene key='ProjectIndex' panHandlers={null} onEnter={(nextState, replace)=>{Actions.replace('ProjectIndex',{p:nextState});return false;}} title ="项目列表" hideNavBar={true} component={ProjectIndex}/>
                       </Scene>
                       <Scene key='business' title='业务'   icon={TabBarIcon} barIndex={2} >
                              <Scene key="MyProject" panHandlers={null} hideNavBar={true} onBackAndroid={()=>{return false}} onEnter={(nextState, replace)=>{console.log('222222222');Actions.replace('MyProject',{p:nextState});console.log('5555555');}} component={MyProject} title="我的项目" backButtonImage={require('./images/back.png')} navigationBarStyle={styles.navigationBar} leftButtonIconStyle={styles.leftButtonIcon} titleStyle={styles.title}/>
                             ...
                             <Scene key="SignedForm" hideTabBar={true} hideNavBar={false} component={SignedForm} title="录签约" onBack={()=>{Actions.popTo('ProjectCustomerDetails',{})}} backButtonImage={require('./images/back.png')} navigationBarStyle={styles.navigationBar} leftButtonIconStyle={styles.leftButtonIcon} titleStyle={styles.title}/>
                             ...
                             <Scene key='ProjectCustomerDetails' hideNavBar={true} hideTabBar={true} component={ProjectCustomerDetails} title ="客户详情（项目）" backButtonImage={require('./images/back.png')} navigationBarStyle={styles.navigationBar} leftButtonIconStyle={styles.leftButtonIcon} titleStyle={styles.title}/>
                       ...
                       <Scene key='custom' title='客源'   icon={TabBarIcon} barIndex={3} >
                               <Scene key='TouristIndex' panHandlers={null} hideNavBar={true} onBackAndroid={()=>{return false}}  component={TouristIndex}  title ="客源" rightButtonImage={require('./images/add.png')} rightButtonIconStyle={styles.rightButtonIcon} rightButtonTextStyle={styles.rightButtonText} onRight={()=>Actions.CustomerEnter({})}/>
                                  ...
                                  <Scene key='CustomerDetails' hideTabBar={true} hideNavBar={false} component={CustomerDetails} title ="客户详情" backButtonImage={require('./images/back.png')} navigationBarStyle={styles.navigationBar} leftButtonIconStyle={styles.leftButtonIcon} titleStyle={styles.title} onBack={()=>{Actions.popTo('MyCustom',{})}} rightTitle="编辑"  rightButtonIconStyle={styles.rightButtonIcon} rightButtonTextStyle={styles.rightButtonText} onRight={()=>Actions.EditCustomerDetails({})}/>
                       ...
                       <Scene key="myhome" title="我的"  icon={TabBarIcon} barIndex={4}  >
                        <Scene key='PersonalIndex' panHandlers={null} hideNavBar={true} onBackAndroid={()=>{return false}} component={PersonalIndex}  title="" />
                          ...
                          <Scene key="Setting"  hideNavBar={false} hideTabBar={true} component={Setting}  title="设置" onBack={()=>{Actions.popTo("PersonalIndex",{})}}  backButtonImage={require('./images/back.png')} leftButtonIconStyle={styles.leftButtonIcon} navigationBarStyle={styles.navigationBar} titleStyle={styles.title}/>
                          ...
                          <Scene key="BindingTeam" hideNavBar={false} hideTabBar={true}  onBack={()=>{Actions.popTo('Index',{})}} onBackAndroid={()=>{Actions.popTo('Index',{})}}  component={BindingTeam} title="绑定团队" backButtonImage={require('./images/back.png')} leftButtonIconStyle={styles.leftButtonIcon} navigationBarStyle={styles.navigationBar} titleStyle={styles.title}/>
                          <Scene key="BindingCompany"  hideNavBar={false} hideTabBar={true} onBack={()=>{Actions.popTo('Index',{})}} onBackAndroid={()=>{Actions.popTo('Index',{})}}  component={BindingCompany} title="绑定公司" backButtonImage={require('./images/back.png')} leftButtonIconStyle={styles.leftButtonIcon} navigationBarStyle={styles.navigationBar} titleStyle={styles.title}/>
                          ...
                          <Scene key="ManageCardList" hideNavBar={false} hideTabBar={true}  component={ManageCardList} title="管理银行卡" onBack={()=>{Actions.popTo('Balance',{})}} backButtonImage={require('./images/backWhite.png')} leftButtonIconStyle={styles.leftButtonIcon} navigationBarStyle={styles.navigationBarDark} titleStyle={styles.titleDark} onRight={()=>Actions.UnbindCardList({})} rightTitle="解绑"  rightButtonIconStyle={styles.rightButtonIcon}  rightButtonTextStyle={styles.rightButtonText}/>
                          ...
                          <Scene key="UnbindCardList" hideNavBar={false} hideTabBar={true}  component={UnbindCardList} title="银行卡（解除绑定）" backButtonImage={require('./images/backWhite.png')} leftButtonIconStyle={styles.leftButtonIcon} navigationBarStyle={styles.navigationBarDark} titleStyle={styles.titleDark}/>
                          ...
                          <Scene key="ApplyWithdraw" hideNavBar={false} hideTabBar={true}  component={ApplyWithdraw} title="申请提现" onBack={()=>{Actions.popTo('Balance',{})}} backButtonImage={require('./images/back.png')} leftButtonIconStyle={styles.leftButtonIcon} navigationBarStyle={styles.navigationBar} titleStyle={styles.title}/>
