            ...
            <TouchableHighlight underlayColor="transparent" onPress={()=>Actions.Details({detailsId:this.state.detailsId,totalList:this.state.totalList})}>
                  <View style={styles.ViewList2}>
                        <View style={styles.ViewList2Text}>
                              <Text style={[fonts.bodyText_Black,styles.titleText]} includeFontPadding={false}>{this.state.title}</Text>
                              <View style={[styles.authorTime2]}>
                                    <Text style={[fonts.hintText_Gray2,styles.widthText]}>{this.state.source}</Text>
...
AppRegistry.registerComponent('NewsListItem', () => NewsListItem);
