...
export default class OrganizationCompany extends BasicComponent {
  constructor(props){
     super(props);
     this.state={
      modalObject:{},
  ...
  render() {
    return (
      ...
      <View style={[styles.nav]}>
            ...
            :
            <TouchableHighlight style={[styles.navLeft]} underlayColor="transparent" onPress={()=>Actions.UnbindCompany({json:this.state.resJson})}>
                  <Text style={[fonts.bodyText_Black]}>解绑</Text>
            </TouchableHighlight>
            }
      </View>
            <View style={[styles.listView]}>
                  <View style={[styles.listViewText]}>
                        <Text style={[fonts.bodyText_Black]}>公司名字:</Text>
                  </View>
...
AppRegistry.registerComponent('OrganizationCompany', () => OrganizationCompany);
