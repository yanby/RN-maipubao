...
export default class BindingCompany extends BasicComponent {
  constructor(props){
     super(props);
     this.state={
       modalObject:{},
  ...
  _submit(){
    storage.load({key: keys.currentUser}).then(currentUser => {
      ...
      let contentInfo={};
      if(this.state.isRecommend ==1 && recommenderId && recommendPhone){
        contentInfo={
        ...
        <StatusBar backgroundColor="transparent" barStyle="dark-content" translucent={true}/>
        {
          ...
          <View style={{flex:1}}>
            <View style={[styles.textMi]}>
                  <Text style={[styles.textMiTxt,fonts.bodyText_Gray]}>公司类用户无法加入团队！</Text>
            </View>
