...
export default class MemberTeam extends ListBasicComponent {
  constructor(props){
    super(props);
    ...
    return (
      ...
      <View style={[styles.nav]}>
            ...
            <View style={[styles.navTitle]}>
                  <Text style={[fonts.t2_Black]}>我的团队</Text>
            </View>
            {
      ...
      </View>
      {
        ...
        <NiceList renderItem={(rowData)=><MemberListItem comeFlag={false} {...rowData} />}
...
AppRegistry.registerComponent('MemberTeam', () => MemberTeam);
