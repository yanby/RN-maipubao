...
export default class RecordSubscription extends BasicComponent {
    constructor(props) {
        super(props);
        this.state = {
            modalObject: {},
        ...
        image.then(a => {
            if (a && a.path) {
                ...
                this.uploadToRemote(a.path).then(respones => {
                    ...
                    this.state.imgPath.push(respones.url);
        ...
        storage.load({
            ...
            syncParams: {
                ...
                body: {
                    ...
                    flowStatus: this.props.flowType + '成功',
                    flowMark: this.state.mark,
                    flowPic: this.state.imgPath.join(';'),
                    operatorType: '项目经理',
            ...
            if (ret.status == 200) {
                try {
                    storage.load({
                        ...
                        syncInBackground: false,
                        syncParams: {
                            url: apis.businessNotify + '?type=录认购&businessId=' + this.state.businessId
                        },
                    }).catch(err => {});
                } catch (e) {}
        ...
        return (<View style={[styles.main]}>
            ...
            <View style={[styles.nav]}>
                  ...
                  <View style={[styles.navCenter]}>
                        <Text style={[fonts.t2_Black]}>录认购（意向）</Text>
                  </View>
            </View>
...
AppRegistry.registerComponent('RecordSubscription', () => RecordSubscription);
