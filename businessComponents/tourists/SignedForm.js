...
export default class SignedForm extends BasicComponent {
  constructor(props) {
    ...
    this.state={
      ...
      types2: [{label: '招商', value: '招商'}, {label: '销售', value: '销售'}],
  ...
  _uploadPaper(){
    if (this.state.idPic.length>30) {
      this.msgShort('最多上传30张签约凭证');
      return;
    }
      ...
      storage.load({
        ...
        syncParams: {
           ...
           body:{
             ...
             flowPic:this.state.paperPic.concat(this.state.idPic).join(';'),
  ...
  validate(){
    ...
    if (!this.state.signPrice || !this.state.signPrice.match(/^[1-9][0-9]*([.]{1}[0-9]{1,2})?$/)) {
      this.msgShort('签约价格必须为数字且不能超过10位')
      return false;
    }
    ...
    if (this.state.paperPic.length==0 || this.state.paperPic.length>30) {
      this.msgShort('签约凭证图片不能为空或者超过30张')
      return false;
    }
    if (this.state.flowMark.length>200) {
      this.msgShort('备注信息不能超过200个字')
      return false;
    }
    return true;
  }
  ...
  render(){
    return (
      <View style={[styles.main]}>
            ...
            <Title isLeftShow={true} backColor={true}  title={'录签约'} >
            </Title>
            <ScrollView style={[styles.scrollView]} ref={(scrollView) => { _scrollView = scrollView; }} automaticallyAdjustContentInsets={false}>
                  <View style={[styles.view]}>
                        <View style={[styles.title]}>
                              <Text style={[styles.titleText,fonts.t3_Black]}>客户基本信息</Text>
                        </View>
                                    ...
                                    return (
                                      <RadioButton labelHorizontal={true} key={i} >
                                         <RadioButtonInput
                                            ...
                                            buttonOuterColor={this.state.gender == obj.value ? '#eaeaea' : '#eaeaea'}
                                            buttonSize={10}
                                            buttonOuterSize={18}
                        ...
                        <View style={[styles.basicInput]}>
                              <View style={[styles.listView]}>
                                    <Text style={[fonts.bodyText_Blue]}>*</Text>
                                    <Text style={[styles.listViewText,fonts.bodyText_Black]}>客户手机号：</Text>
                                    <TextInput
                                      style={[styles.listInput,fonts.bodyText_Gray]}
                                      underlineColorAndroid="transparent"
                                      clearButtonMode="always" returnKeyType='done'
                        ...
                        <View style={[styles.basicInput]}>
                              <View style={[styles.listView]}>
                                    <Text style={[fonts.bodyText_Blue]}>*</Text>
                                    <Text style={[styles.listViewText,fonts.bodyText_Black]}>身份证：</Text>
                                    <TextInput
                                      style={[styles.listInput,fonts.bodyText_Gray]}
                                      underlineColorAndroid="transparent"
                                      clearButtonMode="always" returnKeyType='done'
                  ...
                  <View style={[styles.view]}>
                        <View style={[styles.title]}>
                              <Text style={[styles.titleText,fonts.t3_Black]}>成交项目信息</Text>
                        </View>
                        <View style={[styles.basicInput]}>
                              <View style={[styles.listView]}>
                                    <Text style={[fonts.bodyText_Blue]}>*</Text>
                        ...
                        <View style={[styles.basicInput]}>
                              <View style={[styles.listView]}>
                                    ...
                                    <TextInput
                                      ...
                                      placeholder="请输入商铺编号"
                                      placeholderTextColor="#ccc"
                                      onChangeText={(text)=>this.setState({signShopNo:text})}
                                      onFocus={() => { _scrollView.scrollTo({y: 180}); }}
                                    />
                              </View>
                        </View>
                  ...
                  <View style={[styles.view]}>
                        <View style={[styles.title]}>
                              <Text style={[styles.titleText,fonts.t3_Black]}>成交信息</Text>
                        </View>
                        <View style={[styles.listView]}>
                              <Text style={[fonts.bodyText_Blue]}>*</Text>
                                    ...
                                    return (
                                      <RadioButton labelHorizontal={true} key={i} >
                                         <RadioButtonInput
                                            obj={obj}
                                            index={i}
                                            isSelected={this.state.signType == obj.value}
                                            onPress={onPress}
                                            buttonInnerColor={'#3a8ff3'}
                                            buttonOuterColor={this.state.signType == obj.value ? '#eaeaea' : '#eaeaea'}
                                            buttonSize={10}
                                            buttonOuterSize={18}
                                            buttonWrapStyle={{marginLeft: 10}}
                                          />
                        ...
                        <View style={[styles.basicInput]}>
                              <View style={[styles.listView]}>
                                    ...
                                    <TextInput
                                      ...
                                      placeholder="请输入签约价格"
                                      placeholderTextColor="#ccc"
                                      onChangeText={(text)=>this.setState({signPrice:text})}
                                      onFocus={() => { _scrollView.scrollTo({y: 180}); }}
                                    />
                              </View>
                        </View>
                        <View style={[styles.basicInput]}>
                              <View style={[styles.listView]}>
                                    ...
                                    <DatePicker  style={{width:200,height:20,flex:1}}   date={this.state.signTime}   mode="date"
                                      ...
                                      customStyles={{
                                              dateInput: {
                                                height:20,
                                                position:"absolute",
                                                top:0,left:0,borderWidth:0,
                                              }
                                      }}
                                      onDateChange={(date) => {this.setState({signTime: date})}}
                                    />
                  ...
                  <View style={[styles.view]}>
                        <View style={[styles.addImg]}>
                              <Text style={[fonts.bodyText_Blue]}>*</Text>
                              <Text style={[fonts.bodyText_Black]}>客户身份证：</Text>
                        </View>
                        <View style={{flexWrap:'wrap',flexDirection:"row",marginLeft:15,marginRight:15,marginTop:20}}>
                          {
                            this.state.idPicLocal.map((m,i)=>
                              {
                                return (
                                <TouchableHighlight  underlayColor="transparent" key={i} onPress={()=>this.deleteIDpic(i)}>
                                  <Image style={{width:100,height:100,marginRight:10,marginBottom:10}} source={{uri:m}} key={i} ></Image>
                                </TouchableHighlight>
                                )
                              }
                            )
                          }
                          <TouchableHighlight  underlayColor="transparent" onPress={()=>this._uploadIDCard()}>
                              <Image style={{width:100,height:100,marginRight:10,marginBottom:10}} source={require('../../images/bigAdd.png')}></Image>
                          </TouchableHighlight>
                        </View>
                        ...
                        <View style={{flexWrap:'wrap',flexDirection:"row",marginLeft:15,marginRight:15,marginTop:20}}>
                          {
                            this.state.paperPicLocal.map((m,i)=>
                              {
                                return (
                                <TouchableHighlight  underlayColor="transparent" key={i} onPress={()=>this.deletePaperPic(i)}>
                                  <Image style={{width:100,height:100,marginRight:10,marginBottom:10}} source={{uri:m}} key={i} ></Image>
                                </TouchableHighlight>
                                )
                              }
                  ...
                  <View style={[styles.view]}>
                        <View style={[styles.remarks]}>
                              ...
                              <TextInput
                                ...
                                placeholder="请填写......"
                                placeholderTextColor="#ccc"
                                onChangeText={(text)=>this.setState({flowMark:text})}
                                onFocus={() => { _scrollView.scrollTo({y: 720}); }}
                                blurOnSubmit={true}
                              />
                        </View>
                  </View>
            ...
            <View style={[styles.viewBtn]}>
                  ...
                  <TouchableHighlight style={[styles.listBtn2]}  underlayColor="#3a8ff3" onPress={()=>{this.save()}}>
