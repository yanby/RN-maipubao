...
export default class MyProject extends ListBasicComponent {
  ...
  _initBaseUrl(){
    storage.load({
      ...
      this.setState({
        baseUrl: apis.projectList + '?projectManagerId=' + currentUser.id,
        remoteUrl: apis.projectList + '?projectManagerId=' + currentUser.id + '&sort=sort,desc'
      })
    })
  }
