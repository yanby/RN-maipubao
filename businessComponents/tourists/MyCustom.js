...
import ProjectCustomItem from './ProjectCustomItem';
...
export default class MyCustom extends ListBasicComponent {
  constructor(props){
    super(props);
    this.state={
      modalObject:{},
  ...
  _initBaseUrl(){
    storage.load({
      ...
      this.setState({
        ...
        remoteUrl: apis.customerList + '?userId=' + currentUser.id
      })
    })
  }
        ...
        <View style={styles.dropdownView}>
              <DropDownMenu  style={styles.downView}
                            ...
                            {this.state.remoteUrl ?
                              <NiceList renderItem={(rowData)=><ProjectCustomItem {...rowData} />} contentContainerStyle={styles.list} remoteUrl={this.state.remoteUrl} storkey={this.state.storkey}  isNeedLoading={true} />
                            : null
                            }
          </DropDownMenu>
        </View>
