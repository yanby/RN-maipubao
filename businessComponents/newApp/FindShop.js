...
export default class FindShop extends BasicComponent {
      ...
      <View style={styles.container}>
            ...
            <View style={styles.navDefault}>
                  ...
                  <View style={styles.navCenter}>
                        <Text style={[fonts.t2_Black]}>委托找铺</Text>
                  </View>
            </View>
            <ScrollView style={styles.scrollView} >
                         <Image style={styles.imgView} source={require('../../images/newApp/wtzpImg.png')}>
...
AppRegistry.registerComponent('FindShop', () => personalIndex);
