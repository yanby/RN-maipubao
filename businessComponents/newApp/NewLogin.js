...
export default class NewLogin extends BasicComponent {
        ...
        <Image
          ...
          <View>
            <View style={[styles.loginViewNav]}>
              <TouchableHighlight style={[styles.loginViewNavL]} underlayColor="transparent" onPress={()=>Actions.reset('NewIndex',{})}>
...
AppRegistry.registerComponent('NewLogin', () => Login);
